...
import { Button, Container, FormControl, InputLabel, MenuItem, Pagination, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material'
...
export const PatientList = () => {
    ...
    return (
        <div>
            <Container>
                <Typography variant={"h4"} textAlign="left">Patients List</Typography>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            (<TableRow key={patient.id}>
                                ...
                                <TableCell>
                                    <Button variant="outlined" color="primary" href={"/patient/"+patient.id}>
